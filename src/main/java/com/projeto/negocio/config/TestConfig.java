package com.projeto.negocio.config;
...
import com.projeto.negocio.entities.Payment;
import com.projeto.negocio.entities.Product;
import com.projeto.negocio.entities.User;
import com.projeto.negocio.entities.enums.OrderStatus;
import com.projeto.negocio.repositories.CategoryRepository;
import com.projeto.negocio.repositories.OrderItemRepository;
import com.projeto.negocio.repositories.OrderRepository;
import com.projeto.negocio.repositories.ProductRepository;
...
public class TestConfig implements CommandLineRunner{
	...
	public void run(String... args) throws Exception {
		...
		Order o1 = new Order(null, Instant.parse("2021-07-21T03:42:10Z"), OrderStatus.PAID, u1);
		...
		Payment pay1 = new Payment(null, Instant.parse("2021-07-21T07:42:10Z"), o1);
		o1.setPayment(pay1);
